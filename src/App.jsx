  ...
  return (
    <Routes>
      ...
      <Route path="/admin" element={
        <RutaProtegida roles={['admin']}><AdminLayout /></RutaProtegida>
      }>
      ...
      <Route path="/docente" element={
        <RutaProtegida roles={['docente']}><DocenteLayout /></RutaProtegida>
      }>
        <Route index element={<Navigate to="dashboard" replace />} />
      ...
      <Route path="/ayudante" element={
        <RutaProtegida roles={['ayudante']}><AyudanteLayout /></RutaProtegida>
      }>
        <Route index element={<Navigate to="dashboard" replace />} />
