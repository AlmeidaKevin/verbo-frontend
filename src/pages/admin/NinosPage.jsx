...
const NinosPage = () => {
  ...
  const abrirModal = (nino = null) => {
    setEditando(nino);
    reset(nino ? {
      nombre_completo: nino.nombre_completo, edad: nino.edad || '', grupo_id: nino.grupo_id || '',
      numero_contacto: nino.numero_contacto || '', observacion: nino.observacion || '',
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                      ...
                      {n.grupo && <span className="text-xs bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full">{n.grupo.nombre}</span>}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4" noValidate>
              <div>
                ...
                <input className={`w-full border rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 ${errors.nombre_completo ? 'border-red-400' : 'border-gray-300'}`}
                  ...
                  {...register('nombre_completo', { required: 'El nombre es requerido', validate: v => /^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s]+$/.test(v) || 'Solo se permiten letras en el nombre' })} />
